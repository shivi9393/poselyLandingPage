        ...
        <section className="benefit-section">
            ...
            >
                ...
                <div className={clsx("mt-5 lg:mt-0", { "lg:order-2": imageAtRight })}>
                    <div className={clsx("w-fit flex shadow-2xl rounded-[2.5rem] overflow-hidden border-[3px] border-white/80", { "justify-start": imageAtRight, "justify-end": !imageAtRight })}>
                        <Image src={imageSrc} alt="title" width="384" height="762" quality={100} className="lg:ml-0" unoptimized />
                    </div>
                </div>
            </motion.div>
        </section>
